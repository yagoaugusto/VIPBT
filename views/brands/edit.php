<div class="row">
    <div class="col-md-6 mx-auto">
        <div class="card card-body bg-light mt-5">
            ...
            <p>Preencha o formulário para editar a marca</p>
            <form action="<?php echo URL_ROOT; ?>/brands/edit/<?php echo $id; ?>" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col text-end">
                        <a href="<?php echo URL_ROOT; ?>/brands" class="btn btn-secondary">Cancelar</a>
                    </div>
                </div>
            </form>
        </div>
